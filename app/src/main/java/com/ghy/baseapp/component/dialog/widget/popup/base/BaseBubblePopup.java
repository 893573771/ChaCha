package com.ghy.baseapp.component.dialog.widget.popup.base;
...
import com.ghy.baseapp.component.dialog.animation.BounceEnter.BounceLeftEnter;
import com.ghy.baseapp.component.dialog.animation.FadeExit.FadeExit;
import com.ghy.baseapp.component.dialog.utils.CornerUtils;
import com.ghy.baseapp.component.dialog.utils.StatusBarUtils;
import com.ghy.baseapp.component.dialog.view.TriangleView;
import com.ghy.baseapp.component.dialog.widget.internal.InternalBasePopup;
...
public abstract class BaseBubblePopup<T extends BaseBubblePopup<T>> extends InternalBasePopup<T> {
    ...
    public View onCreateView() {
        View inflate = View.inflate(mContext, R.layout.abs_dialog_popup_bubble, null);
