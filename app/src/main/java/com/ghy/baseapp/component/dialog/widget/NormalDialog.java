package com.ghy.baseapp.component.dialog.widget;
...
import com.ghy.baseapp.component.dialog.widget.internal.BaseAlertDialog;
...
//    private int mTitleLineColor = R.color.colorPrimary;
...
//        mTitleTextColor = Color.parseColor("#61AEDC");
        //使用主题颜色
        mTitleTextColor = context.getResources().getColor(R.color.colorPrimary);
        mTitleLineColor = context.getResources().getColor(R.color.colorPrimary);
        mTitleTextSize = 22f;
